...
if __name__ == '__main__':
    model_path = 'D:/zong/RTDETR-20250508/RTDETR-main/DOTA/train/rt-detr-r18/weights/best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    result = model.val(data='D:/zong/RTDETR-20250303/RTDETR-main/DOTA/data.yaml',
