...
if __name__ == '__main__':
    model = RTDETR('D:/zong/RTDETR-20250508/RTDETR-main/ultralytics/cfg/models/rt-detr/rtdetr-r18.yaml')
    # model.load('') # loading pretrain weights
    model.train(data='D:/zong/RTDETR-20250303/RTDETR-main/DOTA/data.yaml',
                cache=False,
                imgsz=640,
                epochs=150,
                batch=8,
